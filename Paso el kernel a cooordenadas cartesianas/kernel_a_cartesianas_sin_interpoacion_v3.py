...
def Integral_vol_del_kernel(kernel,rAxis,thetaAxis,phiAxis):
    '''Calcula la integral volumetrica del kernel mediante el calculo previo de una matriz de volumenes esfericos, la funcion muestra por pantalla el resultado de la integral
    y devuelve la matriz de volumenes esfericos con ejes segun rAxis thetaAxis y phiAxis.'''
...
# # Grafico un corte del kernel en cartesianas
